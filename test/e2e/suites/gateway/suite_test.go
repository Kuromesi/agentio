...
func extProcObjects(namespace, image string) []*unstructured.Unstructured {
	return extproc.Objects(namespace, image)
}
func setupExtProc(namespace, image string) e2e.SetupFunc { return extproc.Setup(namespace, image) }
