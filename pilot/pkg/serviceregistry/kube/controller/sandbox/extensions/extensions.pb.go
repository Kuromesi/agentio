...
type TrafficPolicyExtension struct {
	...
	Mode          TrafficPolicyMode `protobuf:"varint,2,opt,name=mode,proto3,enum=istio.alibabacloud.extensions.v1.TrafficPolicyMode" json:"mode,omitempty"`
...
type Metadata struct {
	...
	MeshInternalTrafficPolicy MeshInternalTrafficPolicy `protobuf:"varint,2,opt,name=mesh_internal_traffic_policy,json=meshInternalTrafficPolicy,proto3,enum=istio.alibabacloud.extensions.v1.MeshInternalTrafficPolicy" json:"mesh_internal_traffic_policy,omitempty"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
func (x *Metadata) GetMeshInternalTrafficPolicy() MeshInternalTrafficPolicy {
	if x != nil {
...
const file_pilot_pkg_serviceregistry_kube_controller_sandbox_extensions_extensions_proto_rawDesc = "" +
	"\n" +
	"Mpilot/pkg/serviceregistry/kube/controller/sandbox/extensions/extensions.proto\x12 istio.alibabacloud.extensions.v1\"}\n" +
	"\x16TrafficPolicyExtension\x12\x1a\n" +
	"\bpriority\x18\x01 \x01(\x05R\bpriority\x12G\n" +
	"\x04mode\x18\x02 \x01(\x0e23.istio.alibabacloud.extensions.v1.TrafficPolicyModeR\x04mode\"\x93\x02\n" +
	"\bMetadata\x12N\n" +
	"\x06labels\x18\x01 \x03(\v26.istio.alibabacloud.extensions.v1.Metadata.LabelsEntryR\x06labels\x12|\n" +
	"\x1cmesh_internal_traffic_policy\x18\x02 \x01(\x0e2;.istio.alibabacloud.extensions.v1.MeshInternalTrafficPolicyR\x19meshInternalTrafficPolicy\x1a9\n" +
...
var file_pilot_pkg_serviceregistry_kube_controller_sandbox_extensions_extensions_proto_goTypes = []any{
	(MeshInternalTrafficPolicy)(0), // 0: istio.alibabacloud.extensions.v1.MeshInternalTrafficPolicy
	(TrafficPolicyMode)(0),         // 1: istio.alibabacloud.extensions.v1.TrafficPolicyMode
	(*TrafficPolicyExtension)(nil), // 2: istio.alibabacloud.extensions.v1.TrafficPolicyExtension
	(*Metadata)(nil),               // 3: istio.alibabacloud.extensions.v1.Metadata
	nil,                            // 4: istio.alibabacloud.extensions.v1.Metadata.LabelsEntry
}
var file_pilot_pkg_serviceregistry_kube_controller_sandbox_extensions_extensions_proto_depIdxs = []int32{
	1, // 0: istio.alibabacloud.extensions.v1.TrafficPolicyExtension.mode:type_name -> istio.alibabacloud.extensions.v1.TrafficPolicyMode
	4, // 1: istio.alibabacloud.extensions.v1.Metadata.labels:type_name -> istio.alibabacloud.extensions.v1.Metadata.LabelsEntry
	0, // 2: istio.alibabacloud.extensions.v1.Metadata.mesh_internal_traffic_policy:type_name -> istio.alibabacloud.extensions.v1.MeshInternalTrafficPolicy
