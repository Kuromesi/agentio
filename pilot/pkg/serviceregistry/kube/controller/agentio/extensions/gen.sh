...
protoc -I. -I"${ISTIO_API}" -I"${COMMON_PROTOS}" \
    ...
    pilot/pkg/serviceregistry/kube/controller/agentio/extensions/extensions.proto

protoc -I. -I"${ISTIO_API}" -I"${COMMON_PROTOS}" \
  --go_out=. --go_opt=paths=source_relative \
  pilot/pkg/serviceregistry/kube/controller/agentio/extensions/agentioconfig.proto
