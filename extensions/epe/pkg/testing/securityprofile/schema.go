...
var loadSchemas = sync.OnceValues(func() (*crdSchemas, error) {
	...
	return loadCRDSchemas(
		filepath.Join(repoRoot, "manifests/charts/agentio/crds/securityprofiles.yaml"),
		filepath.Join(repoRoot, "manifests/charts/agentio/crds/globalsecurityprofiles.yaml"),
	)
})
...
func repositoryRoot() (string, error) {
	...
	if !ok {
		return "", fmt.Errorf("resolve security profile schema source path")
	}
