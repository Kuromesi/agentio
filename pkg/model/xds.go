...
const (
	...
	PolicyBindingType         = APITypePrefix + "kruise.networking.extensions.v1.PolicyBinding"
...
func GetResourceType(shortType string) string {
	...
	case "PBDS":
		return PolicyBindingType
	case "STPDS":
		return SniTrafficPolicyType
	default:
		return shortType
	}
}
