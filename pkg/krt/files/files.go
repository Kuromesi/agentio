...
//nolint:errcheck,errorlint,revive // Preserve upstream Istio behavior and API; only the KRT import is adapted.
package files
...
func NewFileCollection[F any, O any](
	w *FolderWatch[F],
	transform func(F) *O,
