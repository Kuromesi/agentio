...
func newTrafficPoliciesCollection(
	...
	return newPolicyCollection[*agentsv1alpha1.TrafficPolicy](
		client, stop,
...
func newGlobalTrafficPoliciesCollection(
	...
	return newPolicyCollection[*agentsv1alpha1.GlobalTrafficPolicy](
		client, stop,
		kube.InformerRegistration{
...
func newSecurityProfilesCollection(
	...
	return newPolicyCollection[*agentsv1alpha1.SecurityProfile](
		client, stop,
		kube.InformerRegistration{
...
func newGlobalSecurityProfilesCollection(
	...
	return newPolicyCollection[*agentsv1alpha1.GlobalSecurityProfile](
		client, stop,
		kube.InformerRegistration{
...
func newPolicyCollection[T controllers.ComparableObject](client kube.Client, stop <-chan struct{}, registration kube.InformerRegistration, filter kclient.Filter, options ...krt.CollectionOption) krt.Collection[T] {
	informer := kclient.NewDelayedInformerFor[T](client, registration, filter)
	informer.Start(stop)
