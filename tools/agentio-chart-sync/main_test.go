...
func TestPreparedSandboxControllerBundleCreatesConsumableTrafficProxyConfig(t *testing.T) {
	...
	if !strings.Contains(template, "  # BEGIN GENERATED AGENTIO TRAFFIC PROXY - DO NOT EDIT") {
		t.Fatal("shared sandbox injection ConfigMap does not mark the generated Agentio entry")
	}
