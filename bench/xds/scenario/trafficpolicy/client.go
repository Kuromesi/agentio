...
func (r Round) Validate() error {
	if r.Marker < 1 || r.Marker > 65535 || r.Action < 0 || r.Action > 1 || r.RuleCount < 2 || r.RuleCount > 50001 || r.Ports < 1 || r.Ports > 50000/(r.RuleCount-1) {
...
func New(raw json.RawMessage) (scenario.ClientFactory, error) {
	...
	return scenario.ClientFactory{New: func() scenario.Client { return &client{cfg: cfg} }, PrepareRound: func(raw json.RawMessage) (any, error) {
		var r Round
